...
:url-repo: https://github.com/hyperpolymath/asdf-rethinkdb-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-rethinkdb-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-rethinkdb-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-rethinkdb-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Rethinkdb] versions.
...
Rethinkdb is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Rethinkdb versions per project

|**Project Isolation**
|Pin Rethinkdb per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Rethinkdb version
...
=== Installing Rethinkdb Versions

[source,bash]
----
asdf list all rethinkdb
asdf install rethinkdb latest
asdf install rethinkdb 0.1.0
----
...
[source,bash]
----
asdf global rethinkdb 0.1.0
asdf local rethinkdb 0.1.0
asdf current rethinkdb
rethinkdb --version
----
...
* Ensure `rethinkdb` is on PATH after installation.
* Verify the installed version with `rethinkdb --version`.
